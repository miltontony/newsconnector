$(function(){
    ...
    */
    ...
    var opts = {
        loading: {
            finished: undefined,
            finishedMsg: "<em>No more articles to load.</em>",
        ...
        navSelector  : "#tabs-news div.read-more-cont a.read-more",
    ...
    $('#tabs-news .articles').infinitescroll(opts);

    opts.navSelector = "#tabs-sports div.read-more-cont a.read-more";
    opts.nextSelector = "#tabs-sports div.read-more-cont a.read-more";
    $('#tabs-sports .articles').infinitescroll(opts);

    opts.navSelector = "#tabs-finance div.read-more-cont a.read-more";
    opts.nextSelector = "#tabs-finance div.read-more-cont a.read-more";
    $('#tabs-finance .articles').infinitescroll(opts);
